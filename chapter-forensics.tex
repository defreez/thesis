...
chapter.  Other phones require more invasive processes.  Any analyst of modest means (i.e. without an exploit development team) is
at the mercy of the security/hobbyist community for root access. If the phone cannot be rooted, then an image of the phone cannot be
taken and a logical acquisition will have to suffice. A logical acquisition consists of manually inspecting the phone from the user
...
Use \texttt{nanddump} to acquire an image of each partition on the phone.  These images should be stored on the sterile SD card that
